...
import com.eticaret.jwt.JWTService;
import com.eticaret.model.RefreshToken;
import com.eticaret.model.User;
import com.eticaret.repository.RefreshTokenRepository;
...
public class AuthenticationServiceImpl implements IAuthenticationService{
	...
	private Long getUserId(AuthRequest input) {
	...
	public AuthResponse authenticate(AuthRequest input) {
		try {
			...
			return new AuthResponse(accessToken, savedRefreshToken.getRefreshToken(), getUserId(input));
		} catch (Exception e) {

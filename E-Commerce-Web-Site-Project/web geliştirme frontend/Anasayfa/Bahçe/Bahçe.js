document.addEventListener("DOMContentLoaded", function () {
  ...
  if (!productListString) {
    document.getElementById("bahce-container").innerHTML =
  ...
  const petProducts = productList.filter(
    (p) => p.productCategory === "Bahçe"
  );

  const container = document.getElementById("bahce-container");

  if (!petProducts.length) {
    container.innerHTML =
      "<p>Bahçe kategorisinde ürün bulunamadı.</p>";
    return;
  }

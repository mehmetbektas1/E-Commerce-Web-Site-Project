document.addEventListener("DOMContentLoaded", function () {
  ...
  if (!productListString) {
    document.getElementById("kozmetik-container").innerHTML =
  ...
  const petProducts = productList.filter(
    (p) => p.productCategory === "Kozmetik"
  );

  const container = document.getElementById("kozmetik-container");

  if (!petProducts.length) {
    container.innerHTML =
      "<p>Kozmetik kategorisinde ürün bulunamadı.</p>";
    return;
  }

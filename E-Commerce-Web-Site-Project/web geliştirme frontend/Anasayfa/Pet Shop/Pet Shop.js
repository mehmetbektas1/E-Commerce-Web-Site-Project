document.addEventListener("DOMContentLoaded", function () {
  ...
  if (!productListString) {
    document.getElementById("petshop-container").innerHTML =
  ...
  const petProducts = productList.filter(
    (p) => p.productCategory === "Pet Shop"
  );

  const container = document.getElementById("petshop-container");

  if (!petProducts.length) {
    container.innerHTML =
      "<p>Pet Shop kategorisinde ürün bulunamadı.</p>";
    return;
  }
